  ...
  <article class="w-full p-2 flex flex-col gap-2 lg:px-10">
    ...
    >
      <table class="w-full border-collapse border border-blue-800">
        ...
        <tbody>
          <tr
            v-for="compareGood in comparisonStore.comparison"
            :key="compareGood.id"
            class="border-b border-blue-800 hover:bg-blue-50 transition-colors select-none"
          >
            <td class="p-2">
              {{ compareGood.title }}
            </td>
            <td class="p-2 text-clip">
              <img
                class="w-full max-w-[150px] aspect-square object-contain max-h-96"
                :src="compareGood.img"
                alt=""
            ...
            <td class="p-2">{{ compareGood.price }} ₴</td>
            <td class="text-center">
              <div class="flex gap-3 justify-center items-center">
                ...
                <ClientUiIconButton
                  ...
                  @click="comparisonStore.removeComparison(compareGood.id)"
                />
              </div>
            </td>
          </tr>
