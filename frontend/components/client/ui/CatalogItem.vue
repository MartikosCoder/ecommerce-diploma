...
<template>
  <div
    class="flex flex-col gap-1 cursor-pointer p-5 rounded-lg hover:bg-blue-50 active:bg-blue-100 transition-colors select-none"
    @click="navigateTo(`/good/${good.id}`)"
  >
    <img
      class="w-full aspect-square object-contain max-h-96"
      :src="good.img"
      alt=""
      onerror="this.src = '/img/goods_placeholder.png'"
    />
    ...
    <span v-if="good.price" class="text-blue-900 text-md font-bold"
      >{{ good.price }} ₴</span
    >
